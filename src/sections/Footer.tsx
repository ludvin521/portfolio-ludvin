...
import type { FooterLinkColumn, FooterBottomLink } from '../types/config';
    ...
    >
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        ...
        {footerConfig.columns.length > 0 && (
          ...
          >
            {footerConfig.columns.map((column: FooterLinkColumn, colIndex: number) => (
        ...
        >
          ...
          {footerConfig.bottomLinks.length > 0 && (
            <div className="flex items-center" style={{ gap: 24 }}>
              {footerConfig.bottomLinks.map((bottomLink: FooterBottomLink) => (
                <a
